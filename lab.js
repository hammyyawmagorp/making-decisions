...
/*
  Using an if statement and a comparison operator, create code that will check if Amy or Brittani is older, and then console.log '{name} is older'. Hint: Csituationsider what will happen if they are the same age. Handle this on.
*/
...
if (temperature >= 80 && rain === true) {
  ...
  console.log("Wear a t-shirt and hat");
